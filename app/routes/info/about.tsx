    ...
    <div className="about-container">
      ...
      <section className="mission">
        ...
        <p>
          ...
          lovers, students, and lifelong learners. Whether you're seeking research
          material or your next favorite novel, our collection and tools are here
          for you.
        </p>
      </section>
      ...
      <section className="vision">
        <h2>Our Vision</h2>
        <p>
          To become a leading digital hub of knowledge and creativity by blending
          physical collections with technology-driven resources that adapt to every
          reader's journey.
        </p>
      </section>
      ...
      <section className="connect">
        ...
        <p>
          Follow us for updates on new arrivals, featured books, and campus events.
